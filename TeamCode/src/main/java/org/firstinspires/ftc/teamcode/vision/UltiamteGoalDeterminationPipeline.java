...
public class UltiamteGoalDeterminationPipeline extends OpenCvPipeline
{
    ...
    private static final Point box = new Point(0, 0);
    private static final Scalar green = new Scalar(0, 255, 0);
    private static final int width = 230, height = 230;
    private static final int rings4 = 180, rings1 = 160;
    ...
    public Mat processFrame(Mat input) {
        ...
        determineRings();
        Imgproc.rectangle(input, pointA, pointB, green, -3);
        return input;
    }
